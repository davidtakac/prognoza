...
internal class InternalPrognozaSdkFactory constructor(
  ...
  fun create(): PrognozaSdk {
    ...
    val getForecast =
      GetForecast(forecastRepository, getSelectedMeasurementSystem, computationDispatcher)
    ...
    return object : PrognozaSdk {
      ...
      override val getSelectedMeasurementSystem: GetSelectedMeasurementSystem =
        getSelectedMeasurementSystem
